...
# Normalized scaler (fit transform on train, transform on test)
n_scaler = MinMaxScaler()
X_train_norm = n_scaler.fit_transform(X_train)
X_test_norm = n_scaler.transform(X_test)
print("\nNormalized Feature Scaling Results:")
print("X_train_norm:", X_train_norm[:5])
print("X_test_norm:", X_test_norm[:5])

# Standard scaler (fit transform on train, transform on test)
s_scaler = StandardScaler()
X_train_std = s_scaler.fit_transform(X_train)
X_test_std = s_scaler.transform(X_test)
print("\nStandard Feature Scaling Results:")
