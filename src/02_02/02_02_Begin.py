...
X_train = s_scaler.fit_transform(X_train.astype(np.float_))
X_test = s_scaler.transform(X_test.astype(np.float_))

# TODO: Fit the Linear Regression model on the training data
# TODO: Predict on both training and test datasets
# TODO: Print the coefficients, intercept, and R-squared scores
# TODO: Print model performance scores
#print score
